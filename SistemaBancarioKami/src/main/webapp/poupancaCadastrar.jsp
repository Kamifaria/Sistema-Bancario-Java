...
<head>
<meta charset="UTF-8">
<title>Cadastrar Conta Poupança</title>
...
<body>
	...
	<main>
		<div class="div-form">
			<form action="SvCadastrarCP" method="get">
				<h2>Cadastrar Conta Poupança</h2>
				...
				<label for="iptRendimento">Rendimento:</label>
				<input id="iptRendimento" placeholder="Rendimento" type="text" name="rendimento" value="<%=request.getParameter("rendimento") == null ? "" : request.getParameter("rendimento")%>"/>
				<br><br>
